...
const RoyaleSuite = () => {
  ...
  const getAmenityIcon = (amenity) => {
    const icons = {
      ...
      '65-inch Smart TV': <Tv size={20} />,
      'Free WiFi': <Wifi size={20} />,
      'Spa-inspired Bathroom with Jacuzzi': <Bath size={20} />,
      'Premium Toiletries': <Bath size={20} />,
      'Living Room': <Users size={20} />,
      'Dining Area': <Coffee size={20} />,
      'Kitchenette': <Coffee size={20} />,
      'Coffee Machine': <Coffee size={20} />,
      'Butler Service': <Users size={20} />,
