...
const DeluxeRoom = () => {
  const room = {
    ...
    bedType: "1 King Bed",
    image: bedroomD,
    description: "The Deluxe Room elevates your stay with premium comfort, featuring a spacious layout and enhanced amenities for a truly relaxing experience.",
    longDescription: "Indulge in the elevated comfort of our Deluxe Room, designed to provide a premium experience. The room features a luxurious king-sized bed, a separate seating area, and a spacious bathroom with a walk-in shower. Enhanced amenities include a larger flat-screen TV, complimentary premium toiletries, and a mini-fridge stocked with refreshments.",
    amenities: [
      "Air Conditioning",
      "Flat-Screen TV",
      "Free WiFi",
  ...
  const getAmenityIcon = (amenity) => {
    const icons = {
      ...
      'Private Bathroom with Walk-in Shower': <Bath size={20} />,
