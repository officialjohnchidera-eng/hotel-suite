...
const LuxuryRoom = () => {
  const room = {
    ...
    bedType: "1 King Bed",
    image: bedroomC,
    description: "The Luxury Room offers an unparalleled experience with spacious elegance, premium amenities, and stunning views.",
    longDescription: "Step into the epitome of luxury with our Luxury Room. This generously appointed room features a lavish king-sized bed with premium Egyptian cotton linens, a spacious living area, and a marble bathroom with both a soaking tub and separate shower. Enjoy panoramic views, a 55-inch smart TV, and complimentary access to our executive lounge.",
    amenities: [
      "Air Conditioning",
      "55-inch Smart TV",
      "Free WiFi",
  ...
  const getAmenityIcon = (amenity) => {
    const icons = {
      ...
      '55-inch Smart TV': <Tv size={20} />,
      'Free WiFi': <Wifi size={20} />,
      'Marble Bathroom with Soaking Tub': <Bath size={20} />,
      'Premium Toiletries': <Bath size={20} />,
      'Work Desk': <Coffee size={20} />,
      'Living Area': <Users size={20} />,
      'Mini-Fridge': <Coffee size={20} />,
      'Coffee Machine': <Coffee size={20} />,
      'Executive Lounge Access': <Coffee size={20} />,
