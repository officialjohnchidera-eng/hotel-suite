...
const rooms = [
  { image: bedroomA, price: '₦55,000.00', name: 'Standard Room', bed: '1 Bed', guests: '1 Guest' },
  { image: bedroomB, price: '₦120,000.00', name: 'Julicis Royale Suite', bed: '1 King Bed', guests: '5 Guests' },
  { image: bedroomC, price: '₦85,000.00', name: 'Luxury Room', bed: '1 King Bed', guests: '4 Guests' },
  { image: bedroomD, price: '₦70,000.00', name: 'Deluxe Room', bed: '1 King Bed', guests: '3 Guests' },
  { image: bedroomE, price: '₦65,000.00', name: 'Classic Room', bed: '1 King Bed', guests: '3 Guests' },
  { image: bedroomG, price: '₦150,000.00', name: 'Presidential Suite', bed: '2 King Beds', guests: '6 Guests' },
]
    ...
    <div>
        ...
        >
          ...
          <a
            ...
            style={{
              ...
              opacity: animating ? 0 : 1,
              transform: animating ? 'translateY(30px)' : 'translateY(0)',
              transition: 'opacity 0.5s ease 0.3s, transform 0.5s ease 0.3s, background-color 0.3s ease, color 0.3s ease',
              fontFamily: 'Cormorant Garamond, Times New Roman, serif',
              backgroundColor: 'transparent',
              cursor: 'pointer',
            }}
          ...
          {slides.map((_, index) => (
            <button
              ...
              style={{
                ...
                height: '8px',
                borderRadius: '4px',
                backgroundColor: index === current ? '#eab308' : 'rgba(255,255,255,0.4)',
                border: 'none',
                cursor: 'pointer',
        ...
        >
          ...
          <div className="jul-booking-field" style={{ padding: '16px 18px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <button onClick={() => setAdults(prev => Math.max(1, prev - 1))} style={counterBtnStyle}>−</button>
              <span style={counterValueStyle}>{adults}</span>
              <button onClick={() => setAdults(prev => prev + 1)} style={counterBtnStyle}>+</button>
            </div>
          </div>
          ...
          <div className="jul-booking-field" style={{ padding: '16px 18px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <button onClick={() => setChildren(prev => Math.max(0, prev - 1))} style={counterBtnStyle}>−</button>
              <span style={counterValueStyle}>{children}</span>
              <button onClick={() => setChildren(prev => prev + 1)} style={counterBtnStyle}>+</button>
            </div>
          </div>
      ...
      <div style={{ padding: '100px 24px', backgroundColor: '#ffffff' }}>
        ...
        >
          ...
          <div style={{ flex: '1 1 400px' }}>
            ...
            >
              Since our establishment in 2025, we consistently set high standards in accommodation, dining, and guest experience, becoming a trusted destination for tourists, conferences, events, and special occasions.
            </p>
      ...
      <div style={{ padding: '100px 24px', backgroundColor: '#f9f9f7' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            {[
              { icon: suiteIcon, title: 'Rooms & Suites', desc: 'Elegant rooms designed for ultimate comfort and relaxation.', isLucide: false },
              { icon: ShieldCheck, title: '24-Hour Security', desc: 'Round the clock security to ensure your safety and peace of mind.', isLucide: true },
              { icon: gymIcon, title: 'Fitness Center', desc: 'Stay active with our fully equipped modern fitness center.', isLucide: false },
              { icon: poolIcon, title: 'Swimming Pool', desc: 'Relax and unwind in our clean, well maintained swimming pool.', isLucide: false },
            ].map((item, index) => (
              <div
                key={index}
                style={{
      ...
      <div style={{ padding: '100px 24px', backgroundColor: '#f8f6f3' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '600', color: '#1a1a1a', fontFamily: 'Playfair Display, Georgia, serif', marginBottom: '16px' }}>
              Our Rooms
            </h2>
            <p style={{ color: '#555555', fontSize: '15px', lineHeight: 1.8, maxWidth: '640px', margin: '0 auto' }}>
              Step into comfort and convenience in our beautifully appointed rooms, designed to make your stay truly relaxing.
            </p>
          </div>
            ...
            {rooms.map((room, index) => (
              <div
                ...
                onMouseEnter={e => {
                  ...
                  const panel = e.currentTarget.querySelector('.room-details-panel')
                  if (panel) {
