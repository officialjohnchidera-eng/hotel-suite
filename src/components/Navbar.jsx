...
const Navbar = () => {
  ...
  // Handle mobile navigation with smooth scroll, works across any page
      ...
      >
        <div
          style={{
            ...
            borderRadius: "8px",
            boxShadow:
              "0 20px 60px rgba(0,0,0,0.15), 0 8px 20px rgba(0,0,0,0.06)",
            display: "grid",
    ...
    >
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          transition:
            "max-height 0.6s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.5s ease",
              ...
              <li key={link.name}>
                ...
                <div
                  style={{
                    display: "grid",
                    gridTemplateRows:
                      activeDropdown === link.name ? "1fr" : "0fr",
